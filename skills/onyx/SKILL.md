...
6. Push the setup base commit to the repository remote with `git push origin HEAD` before campaign setup so GitHub-backed campaign creation can verify the base commit.
7. Run `onyx campaign setup --name <slug> --description <goal>`.
